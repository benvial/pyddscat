...
! 22.01.18 (BTD) v4
!                * corrected dimensioning and broadcasting of
!                  BETADF,PHIDF, and THETADF
! end history
!
! Copyright (C) 2002,2003,2004,2007,2008,2013,2014,2022 
!               B.T. Draine and M. Collinge
!
...
! dimensioning information:
      ...
      REAL(WP) ::            &
         ...
         AEFFA(MXRAD),       &
         BETA(MXBETA),       &
         BETADF(MXNAT),      &   ! 22.01.19 BTD corrected NAT0 -> MXNAT
         DX(3),              &
         EM1_LF(3,MXSCA),    &
         EM2_LF(3,MXSCA),    &
         ENSC_LF(3,MXSCA),   &
         ...
         ORDERN(MXSCA),      &
         PHI(MXPHI),         &
         PHIDF(MXNAT),       &   ! 22.01.19 BTD corrected NAT0 -> MXNAT
         PHIN(MXSCA),        &
         SHPAR(12),          &
         THETA(MXTHET),      &
         THETADF(MXNAT),     &   ! 22.01.19 BTD corrected NAT0 -> MXNAT
         THETAN(MXSCA),      &
         WAVEA(MXWAV),       &
         WGTA(MXTHET,MXPHI), &
         WGTB(MXBETA),       &
...
! 22.01.19 (BTD) * corrected MPI_BCAST_REAL calls for
!                  BETADF,PHIDF,THETADF
! end history
! Copyright (C) 2002,2003,2004,2005,2007,2008,2012,2013,2015,2022
...
!***
      ...
      CALL MPI_BCAST_REAL(SINGLE,BETADF,MXNAT,0,IERR)   ! 22.01.19 NATO->MXNAT
...
!***
      CALL MPI_BCAST_REAL(SINGLE,PHIDF,MXNAT,0,IERR)   ! 22.01.19 NAT0->MXNAT
      ...
      CALL MPI_BCAST_REAL(SINGLE,THETADF,MXNAT,0,IERR)   ! 22.01.19 NAT0->MXNAT
!*** diagnostic
