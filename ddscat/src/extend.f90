...
!                   IY(MXNAT0) -> IY(MXNAT)
!                   IZ(MXNAT0) -> IZ(MXNAT)
! 19.08.20 (BTD) v3 (v7.3.3)
!                 * extend NF235 to numbers .le.8192
! end history
! Copyright (C) 1993,1996,1998,2000,2004,2006,2007,2011,2014,2019
!               B.T. Draine and P.J. Flatau
! This code is covered by the GNU General Public License.
!***********************************************************************
! Elements of NF235 are numbers.le.8192  which can be factored by 2,3,5:

      DATA NF235/1,2,3,4,5,6,8,9,10,12,15,16,18,20,24,25,27,30,32, &
