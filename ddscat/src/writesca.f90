...
! 16.04.14 (BTD) v10 modified to support output of up to 16 elements of
!                  Mueller matrix
...
!*** diagnostic
!      write(0,*)'writesca_v10 ckpt 1, myid=',myid
...
!*** diagnostic
!         write(0,*)'writesca_v10 ckpt 2, myid=',myid
!***
         IF(IWRKSC==1)THEN
...
!*** diagnostic
!            write(0,*)'writesca_v10 ckpt 2.1, myid=',myid,' cflsca=',cflsca
...
! Assign "missing value" value if there is only one polarization
         ...
         IF(IWRKSC==1)THEN
            IF(JPBC==0)THEN
               WRITE(8,FMT=9300)(QSCAG(J,1),J=1,3),ITNUM(1),MXITER,NAVG
               IF(IORTH==2)THEN
                  WRITE(8,FMT=9320)(QSCAG(J,2),J=1,3),ITNUM(2),MXITER,NAVG, &
                                   (QAV(J),J=10,12)
               ENDIF
            ENDIF
         ENDIF
         ...
         IF(CMDTRQ=='DOTORQ')THEN
            IF(IWRKSC==1)THEN
               WRITE(8,FMT=9330)(QTRQAB(J,1),J=1,3),(QTRQSC(J,1),J=1,3), &
                                (QTRQAB(J,1)+QTRQSC(J,1),J=1,3)
               IF(IORTH==2)WRITE(8,FMT=9335)(QTRQAB(J,2),J=1,3),    &
                           (QTRQSC(J,2),J=1,3),                     &
...
! write file header information
               ...
               IF(JPBC==0.OR.JPBC==3)THEN
                  ...
                  ELSEIF(NSMELTS==10)THEN
                     WRITE(8,FMT=9090)(SMIND1(J),SMIND2(J),J=1,NSMELTS)
                  ELSEIF(NSMELTS==11)THEN
                     WRITE(8,FMT=9091)(SMIND1(J),SMIND2(J),J=1,NSMELTS)
                  ELSEIF(NSMELTS==12)THEN
                     WRITE(8,FMT=9092)(SMIND1(J),SMIND2(J),J=1,NSMELTS)
                  ELSEIF(NSMELTS==13)THEN
                     WRITE(8,FMT=9093)(SMIND1(J),SMIND2(J),J=1,NSMELTS)
                  ELSEIF(NSMELTS==14)THEN
                     WRITE(8,FMT=9094)(SMIND1(J),SMIND2(J),J=1,NSMELTS)
                  ELSEIF(NSMELTS==15)THEN
                     WRITE(8,FMT=9095)(SMIND1(J),SMIND2(J),J=1,NSMELTS)
                  ELSEIF(NSMELTS==16)THEN
                     WRITE(8,FMT=9096)(SMIND1(J),SMIND2(J),J=1,NSMELTS)
                  ENDIF
               ELSEIF(JPBC==1.OR.JPBC==2)THEN
                  IF(NSMELTS==1)THEN
                  ...
                  ELSEIF(NSMELTS==10)THEN
                     WRITE(8,FMT=9190)(SMIND1(J),SMIND2(J),J=1,NSMELTS)
                  ELSEIF(NSMELTS==11)THEN
                     WRITE(8,FMT=9191)(SMIND1(J),SMIND2(J),J=1,NSMELTS)
                  ELSEIF(NSMELTS==12)THEN
                     WRITE(8,FMT=9192)(SMIND1(J),SMIND2(J),J=1,NSMELTS)
                  ELSEIF(NSMELTS==13)THEN
                     WRITE(8,FMT=9193)(SMIND1(J),SMIND2(J),J=1,NSMELTS)
                  ELSEIF(NSMELTS==14)THEN
                     WRITE(8,FMT=9194)(SMIND1(J),SMIND2(J),J=1,NSMELTS)
                  ELSEIF(NSMELTS==15)THEN
                     WRITE(8,FMT=9195)(SMIND1(J),SMIND2(J),J=1,NSMELTS)
                  ELSEIF(NSMELTS==16)THEN
                     WRITE(8,FMT=9196)(SMIND1(J),SMIND2(J),J=1,NSMELTS)
                  ENDIF
               ENDIF
...
!*** diagnostic
!                  write(0,*)'writesca_v10 ckpt 3, nd=',nd
...
!*** diagnostic
!                  write(0,*)'writesca_v10 ckpt 4, sm(nd,1,1)=',sm(nd,1,1)
!***
                  PPOL=SQRT(SM(2,1,ND)**2+SM(3,1,ND)**2)/SM(1,1,ND)

                  WRITE(8,FMT=9200)THETND,PHIND,PPOL,                     &
...
!         WRITE(8,FMT=9020)CSTAMP,CDESCR,CMDSOL,CALPHA,CSHAPE,NAT0,DX
         ...
         IF(IORTH==1)THEN
            IF(JPBC==0)THEN
               WRITE(8,FMT=9300)(QSCGSUM(J,1),J=1,3),ITNUM(1),MXITER,NAVG
               IF(CMDTRQ=='DOTORQ')WRITE(8,FMT=9330)(QTRQABSUM(J,1),J=1,3), &
                                   (QTRQSCSUM(J,1),J=1,3),                  &
...
!*** diagnostic
!            write(0,*)'writesca_v10 ckpt 5, about to open qtable...'
!***
            ...
            ENDIF
!*** diagnostic
!            write(0,*)'writesca_v10 ckpt 6, about to write to qtable...'
!***
            IF(JPBC==0)THEN
         ...
         ELSEIF(IORTH==2)THEN
            ...
            IF(JPBC==0)THEN
               ...
               WRITE(8,FMT=9300)(QSCGSUM(J,1),J=1,3),ITNUM(1),MXITER,NAVG
               WRITE(8,FMT=9320)(QSCGSUM(J,2),J=1,3),ITNUM(2),MXITER,NAVG, &
                                (QAV(J),J=10,12)
               IF(CMDTRQ=='DOTORQ')THEN
                  WRITE(8,FMT=9330)(QTRQABSUM(J,1),J=1,3),             &
                                   (QTRQSCSUM(J,1),J=1,3),             &
                                   (QTRQABSUM(J,1)+QTRQSCSUM(J,1),J=1,3)
                  WRITE(8,FMT=9335)(QTRQABSUM(J,2),J=1,3),                  &
                                   (QTRQSCSUM(J,2),J=1,3),                  &
...
9031  FORMAT(                                                  &
         'n= (',F8.4,' , ',F8.4,'),  eps.= (',F9.4,' , ',F9.4, &
         ')  |m|kd=',0P,F9.5,' for subs.',I2)
9032  FORMAT(                                                          &
...
9080  FORMAT(                                                    &
         ...
         'directions in ',A12)
9081  FORMAT(' theta    phi    Pol.    S_',2I1)
9082  FORMAT(' theta    phi    Pol.    S_',2I1,8X,'S_',2I1)
9083  FORMAT(' theta    phi    Pol.    S_',2I1,8X,'S_',2I1,8X,'S_',2I1)
9084  FORMAT(' theta    phi    Pol.    S_',2I1,8X,'S_',2I1,8X,'S_',2I1,7X, &
        'S_',2I1)
9085  FORMAT(' theta    phi    Pol.    S_',2I1,8X,'S_',2I1,8X,'S_',2I1,7X, &
        'S_',2I1,7X,'S_',2I1)
9086  FORMAT(' theta    phi    Pol.    S_',2I1,8X,'S_',2I1,8X,'S_',2I1,7X, &
        'S_',2I1,7X,'S_',2I1,7X,'S_',2I1)
9087  FORMAT(' theta    phi    Pol.    S_',2I1,8X,'S_',2I1,8X,'S_',2I1,7X, &
        'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1)
9088  FORMAT(' theta    phi    Pol.    S_',2I1,8X,'S_',2I1,8X,'S_',2I1,7X, &
        'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1)
9089  FORMAT(' theta    phi    Pol.    S_',2I1,8X,'S_',2I1,8X,'S_',2I1,7X,  &
        'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1)
9090  FORMAT(' theta    phi    Pol.    S_',2I1,8X,'S_',2I1,8X,'S_',2I1,7X,    &
        'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1, &
        7X,'S_',2I1)
9091  FORMAT(' theta    phi    Pol.    S_',2I1,8X,'S_',2I1,8X,'S_',2I1,7X,    &
        'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1, &
        2I1,7X,'S_',2I1,7X,'S_',2I1)
9092  FORMAT(' theta    phi    Pol.    S_',2I1,8X,'S_',2I1,8X,'S_',2I1,7X,    &
        'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1, &
        7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1)
9093  FORMAT(' theta    phi    Pol.    S_',2I1,8X,'S_',2I1,8X,'S_',2I1,7X,    &
        'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1, &
        7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1)
9094  FORMAT(' theta    phi    Pol.    S_',2I1,8X,'S_',2I1,8X,'S_',2I1,7X,    &
        'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1, &
        7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1)
9095  FORMAT(' theta    phi    Pol.    S_',2I1,8X,'S_',2I1,8X,'S_',2I1,7X,    &
        'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1, &
        7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',  &
        2I1)
9096  FORMAT(' theta    phi    Pol.    S_',2I1,8X,'S_',2I1,8X,'S_',2I1,7X,    &
        'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1, &
        7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',  &
        2I1,7X,'S_',2I1)
!-----------------------------------------------------------------------
9181  FORMAT(' alpha   zeta    Pol.    S_',2I1)
9182  FORMAT(' alpha   zeta    Pol.    S_',2I1,8X,'S_',2I1)
9183  FORMAT(' alpha   zeta    Pol.    S_',2I1,8X,'S_',2I1,8X,'S_',2I1)
9184  FORMAT(' alpha   zeta    Pol.    S_',2I1,8X,'S_',2I1,8X,'S_',2I1,7X, &
        'S_',2I1)
9185  FORMAT(' alpha   zeta    Pol.    S_',2I1,8X,'S_',2I1,8X,'S_',2I1,7X, &
        'S_',2I1,7X,'S_',2I1)
9186  FORMAT(' alpha   zeta    Pol.    S_',2I1,8X,'S_',2I1,8X,'S_',2I1,7X, &
        'S_',2I1,7X,'S_',2I1,7X,'S_',2I1)
9187  FORMAT(' alpha   zeta    Pol.    S_',2I1,8X,'S_',2I1,8X,'S_',2I1,7X, &
        'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1)
9188  FORMAT(' alpha   zeta    Pol.    S_',2I1,8X,'S_',2I1,8X,'S_',2I1,7X, &
        'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1)
9189  FORMAT(' alpha   zeta    Pol.    S_',2I1,8X,'S_',2I1,8X,'S_',2I1,7X,  &
        'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1)
9190  FORMAT(' alpha   zeta    Pol.    S_',2I1,8X,'S_',2I1,8X,'S_',2I1,7X,    &
        'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1, &
        7X,'S_',2I1)
9191  FORMAT(' alpha   zeta    Pol.    S_',2I1,8X,'S_',2I1,8X,'S_',2I1,7X,    &
        'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1, &
        7X,'S_',2I1,7X,'S_',2I1)
9192  FORMAT(' alpha   zeta    Pol.    S_',2I1,8X,'S_',2I1,8X,'S_',2I1,7X,    &
        'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1, &
        7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1)
9193  FORMAT(' alpha   zeta    Pol.    S_',2I1,8X,'S_',2I1,8X,'S_',2I1,7X,    &
        'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1, &
        7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1)
9194  FORMAT(' alpha   zeta    Pol.    S_',2I1,8X,'S_',2I1,8X,'S_',2I1,7X,    &
        'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1, &
        7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1)
9195  FORMAT(' alpha   zeta    Pol.    S_',2I1,8X,'S_',2I1,8X,'S_',2I1,7X,    &
        'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1, &
        7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',  &
        2I1)
9196  FORMAT(' alpha   zeta    Pol.    S_',2I1,8X,'S_',2I1,8X,'S_',2I1,7X,    &
        'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1, &
        7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',2I1,7X,'S_',  &
        2I1,7X,'S_',2I1)
!-----------------------------------------------------------------------
