...
from conf import html_theme_options

import pyddscat as package

primary_color = html_theme_options["light_css_variables"]["color-brand-primary"][1:]
...
def process_html(fn, lines):
    ...
    for line in lines:
        ...
        line = line.replace(
            "mybinder.org/v2/gh/phokaia/pyddscat",
            "mybinder.org/v2/gl/phokaia%2Fpyddscat",
        )
        # line = line.replace(
        #     "mybinder.org/v2/gl/phokaia%2Fpyddscat/doc?filepath=notebooks/examples/",
        #     "mybinder.org/v2/gl/phokaia%2Fpyddscat/doc?filepath=notebooks/",
        # )
        ...
        new_binder_badge = f"https://img.shields.io/badge/run-online-{primary_color}.svg?style=for-the-badge&labelColor=444444&logo=data:image/png;base64,"
        line = line.replace(
...
def process_tex(lines):
    ...
    for line in lines:
        if (
            line.startswith(r"\section{pyddscat.")
            or line.startswith(r"\subsection{pyddscat.")
            or line.startswith(r"\subsubsection{pyddscat.")
            or line.startswith(r"\paragraph{pyddscat.")
            or line.startswith(r"\subparagraph{pyddscat.")
        ):
            pass  # skip!
        else:
            new_lines.append(line)
